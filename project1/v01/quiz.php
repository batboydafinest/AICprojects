  ...
  <body>
    ...
    <form class="form" action="quizresults.php" method="post">
      ...
      <div class="box">
        ...
        <p>What is you name? <input type="text" name="name" maxlength="25"></p>
        <br>
        ...
        <p>What is your birthday? <input type="date" name="bday"></p>

        <br>

        <p>What is your email? <input type="email" name="email"></p>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q1" value="Heart Wants What it Wants" id="heart">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q2" value="I Would Like" id="would">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q3" value="Sorry" id="sorry">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q4" value="Diamonds" id="diamonds">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q5" value="Havana" id="havana">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q6" value="500 Miles" id="miles">
        </div>

        <div>
          <label for="shut">Walk the Moon - Shut Up and Dance</label>
          <input type="radio" name="q6" value="" id="shut">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q7" value="God's Plan" id="god">
        </div>

        <div>
          <label for="lose">Eminem - Lose Yourself</label>
          <input type="radio" name="q7" value="" id="lose">
        </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q8" value="Close" id="close">
        </div>
        ...
        <div>
          ...
          <input type="radio" name="q8" value="" id="face">
        </div>
      </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q9" value="Dusk Till Dawn" id="dusk">
        </div>
        ...
        <div>
          ...
          <input type="radio" name="q9" value="" id="maps">
        </div>
      </div>
      ...
      <div class="box">
        ...
        <div>
          ...
          <input type="radio" name="q10" value="Closer" id="closer">
        </div>
